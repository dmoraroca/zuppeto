...
const rawTests = [
  ...
  { screen: 'Login (/login)', priority: 'Mitja', description: 'Cercar des del login', steps: 'Clic «Cercar» amb filtres aplicats', expected: 'Navega cap al flux de places (guest/login segons estat)' },
  ...
  { screen: 'Llocs (/places)', priority: 'Alta', description: 'Cercar (càrrega sota demanda)', steps: 'Configurar filtres → «Cercar»', expected: 'Es carreguen resultats des del servidor (amb memòria de cerca)' },
  ...
  { screen: 'Favorits (/favorites)', priority: 'Mitja', description: 'Enllaç més llocs a la ciutat des de la targeta', steps: 'A una targeta de favorit, al costat de Veure detall', expected: '«Més llocs a {ciutat}» obre /places amb aquella ciutat' },
  { screen: 'Favorits (/favorites)', priority: 'Mitja', description: 'Filtre cerca dins favorits', steps: 'Escriure al camp cerca i clicar «Cercar»', expected: 'Graella filtrada per nom/ciutat/etiqueta només sobre favorits de BD; sense Cercar no canvia' },
  { screen: 'Favorits (/favorites)', priority: 'Mitja', description: 'Filtre ciutat dins favorits', steps: 'Seleccionar ciutat al combobox i clicar «Cercar»', expected: 'Només favorits d\'aquesta ciutat; el combo no crida cerca remota de ciutats' },
  { screen: 'Favorits (/favorites)', priority: 'Mitja', description: 'Ordre: recents / valoració / nom', steps: 'Canviar selector d\'ordre i clicar «Cercar»', expected: 'Ordre de la graella canvia després de Cercar' },
  { screen: 'Favorits (/favorites)', priority: 'Mitja', description: 'Netejar filtres de favorits', steps: 'Aplicar filtres → «Netejar» o «Netejar tots els filtres»', expected: 'Es mostren tots els favorits de nou' },
