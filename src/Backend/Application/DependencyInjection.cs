...
public static class DependencyInjection
{
    public static IServiceCollection AddApplication(this IServiceCollection services)
    {
        ...
        services.AddScoped<IFederatedAuthenticationService, FederatedAuthenticationService>();
        ...
        services.AddScoped<ICommandHandler<UpdateAdminUserCommand, Results.Result<Users.UserDto>>, UpdateAdminUserCommandHandler>();
        ...
        services.AddSingleton<IValidator<UpdateAdminUserRequest>, UpdateAdminUserRequestValidator>();
