# Política de privacitat i dades (Zuppeto)
...
Quan el producte consulti **GeoNames** (o serveis equivalents acordats) per suggerir **països** o **ciutats** abans de desar-los al catàleg Zuppeto:
